...
export const Route = createFileRoute("/diferencial")({
  head: () => ({
    meta: [
      { title: "Diferencial · BrandShield AI vs. concorrentes" },
      {
        name: "description",
        content:
          "Comparativo entre BrandShield AI e as demais plataformas de proteção de marca: Threat Graph, IA preditiva, deepfake, dark web, playbooks e ROI em tempo real.",
      },
      { property: "og:title", content: "BrandShield AI vs. concorrentes" },
      {
        property: "og:description",
        content:
          "Veja por que a BrandShield AI vai muito além do brand bidding — 12 diferenciais que ninguém mais entrega.",
      },
...
const differentials = [
  ...
  },
  {
    ...
    desc: "Sua agência revende o BrandShield com marca própria. Nenhum concorrente oferece esse modelo B2B2B.",
  },
];
          ...
          <div className="relative mx-auto max-w-7xl px-4 pb-20 pt-20 md:pt-28">
            <div className="mx-auto max-w-3xl text-center">
              <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-border/60 bg-card/40 px-3 py-1 text-xs text-muted-foreground backdrop-blur">
                ...
                Comparativo · BrandShield AI vs. concorrentes
              </div>
              <h1 className="font-display text-4xl font-bold tracking-tight md:text-6xl">
                Por que a BrandShield vai muito{" "}
                <span className="text-gradient">além do brand bidding</span>.
              </h1>
              <p className="mt-6 text-lg text-muted-foreground">
                As demais plataformas do mercado protegem 1 ou 2 canais.
                A BrandShield entrega 12 diferenciais que ninguém mais opera —
        ...
        <section className="relative py-20">
          ...
          <div className="relative mx-auto max-w-6xl px-4">
            <div className="mb-10 text-center">
              ...
              <h2 className="mt-3 font-display text-3xl font-bold md:text-5xl">
                BrandShield AI vs. o resto do mercado
              </h2>
            </div>
            ...
            <div className="glass-strong ring-gradient overflow-hidden rounded-3xl">
              <div className="grid grid-cols-[1fr_120px_140px] items-center gap-4 border-b border-border/60 p-4 md:grid-cols-[1fr_160px_160px] md:p-6">
                ...
                <div className="text-center">
                  ...
                  <div className="mt-1 font-display text-sm font-bold">BrandShield AI</div>
                </div>
                <div className="text-center">
